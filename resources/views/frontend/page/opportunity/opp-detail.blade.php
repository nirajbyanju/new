...
@section('title', $posting->tittleofopportunity)
@section('content')
    @push('meta')
    <meta name="description" content="Opportunities Circle Nepal Scholarships, Fellowships, Internships, Jobs" />
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
    <meta name="keywords" content="Opportunities, Circle, sharing,{{$posting->tags}}">
     <!-- facebook-og -->
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="{{$posting['nameofcompany']}}" />
    <meta property="og:description" content="@if(!empty($posting->descriptions))
                                                <?php
                                            $strippedBio = strip_tags($posting->descriptions);
                                            $words = str_word_count($strippedBio, 1);
                                            $limitedBio = implode(' ', array_slice($words, 0, 20));
                                            ?>
                                            {{ $limitedBio }}
                                                @endif" />
    ...
    <meta property="article:published_time" content="{{$posting->created_at}}" />
    <meta property="article:modified_time" content="{{$posting->updated_at}}" />
    <meta property="og:updated_time" content="{{$posting->updated_at}}" />
    <meta property="og:image" content="{{asset('opcn/uploads/opportunity/' .$posting->uploadcover)}}" />
    <meta property="og:image:secure_url" content="{{asset('opcn/uploads/opportunity/' .$posting->uploadcover)}}" />
    <meta property="og:image:width" content="726" />
    <meta property="og:image:height" content="322" />

    <!-- Twitter-og -->
    <meta name="twitter:card" content="{{asset('opcn/uploads/opportunity/' .$posting->uploadcover)}}" />
    <meta name="twitter:description" content="Opportunities Sharing Circle" />
    <meta name="twitter:title" content=" {{$posting->tittleofopportunity}}" />
    <meta name="twitter:site" content="{{URL::full()}}" />
    <meta name="twitter:image" content="{{asset('opcn/uploads/opportunity/' .$posting->uploadcover)}}" />
