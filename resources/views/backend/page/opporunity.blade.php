...
<div class="page-header">
  <!-- PAGE-HEADER -->
  <div>
    <h1 class="page-title">Posting Opportunity</h1>
    <ol class="breadcrumb">
...
@endpush
        ...
        <div class="form-row">
                  ...
                  <div class="col-md-4 mb-3 form-icon">
                    ...
                    <select class="form-control " id="validationServer02" name="fundingtype"></i> 
                      ...
                      <option value="Entrepreneurship Event" >Entrepreneurship Event</option>
      ...
      <form id="myForms" action="" method="post" enctype="multipart/form-data" class="login-form">
        @csrf
        <div class="form-row">
          <div class="col-md-12 mb-3 form-icon">
            <label for="validationServer01" id="validationServer01" >Tittle of Opportunity</label>
        <input type="text" name="tittleofopportunity" class="form-control is-invalid" id="validationServer02" placeholder="Tittle of Opportunity" value="{{ old('tittleofopportunity') }}" oninput="checkInput(this, 1)">
      ...
      <div class="form-row">
        ...
        <div class="col-md-9 mb-3">
            ...
            <div id="upload-photo2">
              ...
              <img id="preview-photo2" class="upload-logo">
      ...
      <div class="form-row"></div>
        ...
        <div class="form-row">
              ...
              <input type="text" name="sponsorby" class="form-control is-invalid" id="validationServer02" placeholder="Sponsor By" value="{{ old('sponsorby') }}" oninput="checkInput(this, 1)">
              <i class="fas fa-building"></i> 
            </div>
          ...
          <div class="form-row">
            ...
            <div class="col-md-4 mb-3 form-icon">
              ...
              <input type="text" name="location" class="form-control is-invalid" id="validationServer02" placeholder="Location" value="{{ old('location') }}" required  oninput="checkInput(this, 1)">
              <i class="fas fa-map-marker-check"></i>
            </div>
          ...
          <div class="col-md-4 mb-3 form-icon">
            ...
            <div class="col-md-4 mb-3 form-icon">
              ...
              <input type="text" name="numberofopportunity" class="form-control is-invalid" id="validationServer02" placeholder="Number of Opportunity" value="{{ old('numberofopportunity') }}" required  oninput="checkInput(this, 1)">
          ...
          <div class="col-md-4 mb-3 form-icon">
            ...
            <input type="text" name="subtopic" class="form-control is-invalid" list="salary" id="validationServer02" placeholder="Sub Topic" value="{{ old('subtopic') }}" required  oninput="checkInput(this, 1)">
